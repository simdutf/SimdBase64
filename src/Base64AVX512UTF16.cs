...
namespace SimdBase64
{
    namespace AVX512
    {
        public static partial class Base64
        {
            ...
            public unsafe static OperationStatus DecodeFromBase64AVX512(ReadOnlySpan<char> source, Span<byte> dest, out int bytesConsumed, out int bytesWritten, bool isUrl = false)
            {
            ...
            private unsafe static OperationStatus InnerDecodeFromBase64AVX512Regular(ReadOnlySpan<char> source, Span<byte> dest, out int bytesConsumed, out int bytesWritten)
            {
            ...
            private unsafe static OperationStatus InnerDecodeFromBase64AVX512Url(ReadOnlySpan<char> source, Span<byte> dest, out int bytesConsumed, out int bytesWritten)
            {
                // translation from ASCII to 6 bit values
                bool isUrl = true;
                bytesConsumed = 0;
