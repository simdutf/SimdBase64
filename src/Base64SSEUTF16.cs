...
namespace SimdBase64
{
    public static partial class Base64
    {
        ...
        private unsafe static OperationStatus InnerDecodeFromBase64SSERegular(ReadOnlySpan<char> source, Span<byte> dest, out int bytesConsumed, out int bytesWritten)
        {
        ...
        private unsafe static OperationStatus InnerDecodeFromBase64SSEUrl(ReadOnlySpan<char> source, Span<byte> dest, out int bytesConsumed, out int bytesWritten)
        {
            // translation from ASCII to 6 bit values
            bool isUrl = true;
