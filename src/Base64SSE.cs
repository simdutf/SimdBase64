...
namespace SimdBase64
{
...

    {
        ...
        // Caller is responsible for checking that Ssse3.IsSupported && Popcnt.IsSupportedMaximalBinaryLengthFromBase64Scalar
        ...
        //                         ReadOnlySpan<byte> remainder= source.Slice(Math.Max(0,bytesConsumed));

        //                         OperationStatus result =
        //                             Base64WithWhiteSpaceToBinaryScalar(remainder, dest.Slice(Math.Max(0,bytesWritten)), out remainderBytesConsumed, out remainderBytesWritten, isUrl);
