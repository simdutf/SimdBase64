# SimdBase64 documentation site

This folder contains the source for the SimdBase64 documentation site, built with
...
| `api/` | API reference. The `*.yml` files are **generated** from the source and are git-ignored. |
