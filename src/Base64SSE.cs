...
namespace SimdBase64
{
...

    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private unsafe static OperationStatus InnerDecodeFromBase64SSE(ReadOnlySpan<byte> source, Span<byte> dest, out int bytesConsumed, out int bytesWritten, bool isUrl = false)
        {
            // translation from ASCII to 6 bit values
            byte[] toBase64 = isUrl == true ? Tables.ToBase64UrlValue : Tables.ToBase64Value;
            bytesConsumed = 0;
